...
class WC_Shiptor_Tracking_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = __( 'Shiptor Tracking Code', 'woocommerce-shiptor' );
		$this->customer_email   = true;
		$this->description      = __( 'This email is sent when configured a tracking code within an order.', 'woocommerce-shiptor' );
		$this->heading          = __( 'Your order has been sent', 'woocommerce-shiptor' );
		$this->subject          = __( '[{site_title}] Your order {order_number} has been sent by Shiptor', 'woocommerce-shiptor' );
		$this->message          = __( 'Hi there. Your recent order on {site_title} has been sent by Shiptor.', 'woocommerce-shiptor' )
									. PHP_EOL . ' ' . PHP_EOL
									. __( 'To track your delivery, use the following the tracking code(s): {tracking_code}', 'woocommerce-shiptor' )
									. PHP_EOL . ' ' . PHP_EOL
									. __( 'The delivery service is the responsibility of the Shiptor, but if you have any questions, please contact us.', 'woocommerce-shiptor' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled' => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable this email notification', 'woocommerce-shiptor' ),
				'default' => 'yes',
			),
			'subject' => array(
				'title'       => __( 'Subject', 'woocommerce-shiptor' ),
				'type'        => 'text',
				'description' => sprintf( __( 'This controls the email subject line. Leave blank to use the default subject: <code>%s</code>.', 'woocommerce-shiptor' ), $this->subject ),
				'placeholder' => $this->subject,
				'default'     => '',
				'desc_tip'    => true,
			),
			'heading' => array(
				'title'       => __( 'Email Heading', 'woocommerce-shiptor' ),
				'type'        => 'text',
				'description' => sprintf( __( 'This controls the main heading contained within the email. Leave blank to use the default heading: <code>%s</code>.', 'woocommerce-shiptor' ), $this->heading ),
				'placeholder' => $this->heading,
				'default'     => '',
				'desc_tip'    => true,
			),
			'tracking_message' => array(
				'title'       => __( 'Email Content', 'woocommerce-shiptor' ),
				'type'        => 'textarea',
				'description' => sprintf( __( 'This controls the initial content of the email. Leave blank to use the default content: <code>%s</code>.', 'woocommerce-shiptor' ), $this->message ),
				'placeholder' => $this->message,
				'default'     => '',
				'desc_tip'    => true,
			),
			'email_type' => array(
				'title'       => __( 'Email type', 'woocommerce-shiptor' ),
				'type'        => 'select',
				'description' => __( 'Choose which format of email to send.', 'woocommerce-shiptor' ),
				'default'     => 'html',
	...
	protected function get_custom_email_type_options() {
		...
		$types = array( 'plain' => __( 'Plain text', 'woocommerce-shiptor' ) );

		if ( class_exists( 'DOMDocument' ) ) {
			$types['html']      = __( 'HTML', 'woocommerce-shiptor' );
			$types['multipart'] = __( 'Multipart', 'woocommerce-shiptor' );
		}
